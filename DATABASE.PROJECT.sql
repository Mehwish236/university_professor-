...
SELECT DISTINCT u1.firstname, u1.lastname, un.id
FROM university_professors u
JOIN universities un ON u1.university = un.university;

select *
from professors

INSERT INTO affiliations (professor_id, function, organization_id)
SELECT DISTINCT p1.id, u1.function, o.id
FROM university_professors u1
JOIN professors p1 ON u1.firstname = p1.firstname AND u1.lastname = p1.lastname
JOIN organizations o ON u1.organization = o.organization;
